...
?>
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <div class="container">
            <ol class="breadcrumb" data-aos="fade-right">
                ...
                <li class="breadcrumb-item active" aria-current="page">Fazenda Souza e Vila Seca</li>
            </ol>
        </div>
    </nav>
    ...
    <header class="hero" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('../img/img.fazendasouza.png'); height: 50vh;" data-aos="fade-in">
        <div class="container">
            <h1 style="text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">Fazenda Souza e Vila Seca</h1>
            <p class="lead" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">Tradição colonial, hortifrutigranjeiros e a hospitalidade da Serra Gaúcha.</p>
        </div>
    </header>

  <main class="content-section">
    <div class="container">
      <h2 class="mb-5" data-aos="fade-up">🏢 Empreendimentos em Fazenda Souza</h2>
  ...
  $destino_nome = $dest_data['titulo'] ?? 'Fazenda Souza';
