...
?>
    ...
    <nav aria-label="breadcrumb" class="breadcrumb-nav">
        <div class="container">
            <ol class="breadcrumb" data-aos="fade-right">
                ...
                <li class="breadcrumb-item active" aria-current="page">Terceira Légua</li>
            </ol>
        </div>
    </nav>
    ...
    <header class="hero" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('../img/img.terceiralegua.png'); height: 50vh;" data-aos="fade-in">
        <div class="container">
            <h1 style="text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">Roteiro Terceira Légua</h1>
            <p class="lead" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">Gastronomia típica italiana, vinícolas tradicionais e paisagens exuberantes.</p>
        </div>
    </header>

  <main class="content-section">
    <div class="container">
      <h2 class="mb-5" data-aos="fade-up">🏢 Empreendimentos em Terceira Légua</h2>
  ...
  $destino_nome = $dest_data['titulo'] ?? 'Terceira Légua';
